...
Объектно-ориентированное программирования (ООП) - это методология программирования, при которой программа организуется как совокупность взаимодействующих объектов,
каждый из которых является экземпляром какого-либо класса, а классы образуют иерархию наследования.
При этом классы считаются статичными, а объектам присуща динамика, что выражается в полиморфизме. 

Класс – это тип, описывающий множество предметов реального мира, имеющих одинаковые основные характеристики (данные) и правила поведения (методы обработки данных).
Объект – это типичный представитель (экземпляр, абстрактный представитель) своего класса.
...
5) полиморфизм - некоторому действию придается одно имя, которое совместно используется объектами всей иерархии, причем каждый объект иерархии реализует это действие 
своим собственным, подходящим для него, образом
