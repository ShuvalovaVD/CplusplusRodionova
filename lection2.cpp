// Лекция 2. Оператор ::, ссылки и указатели, описание дружественных функций
...
void mult(ODMAS & m, int k) {
	for (int i = 0; i < m.N; i++){
		m.mas[i] = m.mas[i] * k;  // то есть можно образаться к элементам класса через точку, необязательно писать ф-цию elem
	}
}
